                ...
                "messages": [
                    {
                        ...
                        "content": (
                            ...
                            "You can provide only these capabilities: "
                            "chat, text product search, image product search, and multimodal product search. "
                            "You can search only products that exist in the database. "
                            "Your job here is only intent routing. "
                            ...
                            "If the user is clearly asking to search database products, route to a search intent. "
                            "Otherwise, route to chat. "
                            "Chat is limited to: greetings, capability questions, how to use the assistant, "
                            "clarifying search needs, and discussing search results already returned by the system. "
                            ...
                            "Text product lookup is text-search. "
                            "Image only is image-search. "
                            "Text plus image is multimodal-search. "
                            "Do not classify capability questions as search. "
                            "Examples: "
